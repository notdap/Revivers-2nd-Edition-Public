/*
    No idea who coded this, it's the only ActionBar that would work though.
*/
...
public class ActionBar {
    ...
    public void sendActionBar(Player player, String message) {
        ...
        try {
            ...
            Object handle = getMethod(player.getClass(), handle1, new Class[0]).invoke(player, new Object[0]);
            String playerConnection1 = "playerConnection";
            Object playerConnection = getField(handle.getClass(), playerConnection1).get(handle);
...
//    		}
    ...
    public void sendActionBar(final Player player, final String message, int duration) {
        ...
        if (duration >= 0) {
            ...
            }.runTaskLater(ReviversTwo.getPlugin(), duration + 1);
        }
        ...
        while (duration > 60) {
            ...
            }.runTaskLater(ReviversTwo.getPlugin(), sched);
        }
    }
